                            ...
                            <div className="w-full flex flex-col items-center justify-center mb-3 pt-10 pb-6">
                                ...
                                <div className="w-[70%] flex items-center justify-around mt-4">
                                    ...
                                    <div className="flex items-center gap-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 fill-[#8ACDD7]" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                {/* Chat */}
                                <button className="flex items-center gap-1 mt-6 bg-[#87CBB9] text-white text-lg rounded-lg px-4 py-2 hover:bg-[#B9EDDD] hover:text-black">
                        ...
                        <div className="flex flex-col w-2/3">
                            ...
                            <div className="w-full bg-[#F4F4F4] rounded-lg drop-shadow-xl mt-10 py-8 px-4">
                                <div className="flex justify-between px-6">
                                    ...
                                    <div className="flex flex-col">
                                        <p className="font-bold text-3xl text-center">{ticket.quantity}</p>
                            ...
                            <div className="bg-[#F4F4F4] rounded-t-lg drop-shadow-xl mt-6 py-8 px-10">
                                ...
                                <p className="text-sm text-gray-400 mt-2">Original Price: <span className="text-gray-400 font-bold">{formatCurrency(ticket.originalPrice)}/Ticket</span></p>
                                <div className="flex items-center justify-between px-3 pt-6 mt-6 border-t-2">
                                    ...
                                    <div className="flex justify-center items-center">
                                        ...
                                        <p className="text-center mx-1 py-2 w-16 rounded-sm border-2 border-gray-300 cursor-not-allowed">{quantity}</p>
