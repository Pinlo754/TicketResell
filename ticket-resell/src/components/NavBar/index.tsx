            ...
            <nav className="fixed top-0 left-0 w-full bg-black/50 p-4 z-50 backdrop-blur-lg">
                <div className="max-w-8xl mx-auto flex justify-between items-center">
                    ...
                    <ul className="flex space-x-6">
                        ...
                        {/* Chat */}
                        <li className="text-white hover:text-gray-300 cursor-pointer">
                        <svg onClick={() => navigate('/chat')} xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-current" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        {/* Cart */}
                        <li className="text-white hover:text-gray-300 cursor-pointer">
                        <svg onClick={() => navigate('/cart')} xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-current" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
