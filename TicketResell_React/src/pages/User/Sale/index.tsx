                    ...
                    <div key={order.orderId} className="bg-gray-100 mt-6">
                      <div className="p-4">
                        ...
                        {order.tickets.map((ticket, index) => {
                          ...
                          return (
                            <div 
                            key={ticket.ticketId} className="border-t cursor-pointer"
                            onClick={() => navigate("/user/sale/orderDetail")}
                            >
                              <div
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex justify-between items-end mt-4">
                          ...
                          {/* Button */}
                          <div className="">
                            <button className="rounded p-2 bg-[#B9EDDD] hover:bg-[#87CBB9] hover:text-white">
                              Xác nhận
                            </button>
                          </div>
                        </div>
