      ...
      <div className="w-[75%] mx-auto py-8 grid grid-cols-1 md:grid-cols-4 md:space-x-0 md:divide-x-2 divide-gray-300">
        ...
        <div className="flex flex-col md:flex-row items-center space-x-4 p-4">
          ...
          <div>
            ...
            <p className="text-gray-500">
              Hỗ trợ trực tuyến bất cứ khi nào bạn cần.
            </p>
          </div>
        </div>
      </div>
      ...
      <footer className="w-screen bg-black text-white pt-4 divide-y divide-gray-600">
        ...
        <div className="flex flex-col items-center mt-14">
          <img
            src={logo}
            alt="Festix"
            className="mb-2 w-16 h-20 cursor-pointer"
        ...
        <div className="w-[90%] mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 pl-24 mt-14 pt-14">
          {/* Contact Section */}
          <div>
            ...
            <div className="flex items-center mt-2 group pointer-events-auto">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-8 h-8 mr-1 group-hover:text-gray-400"
                fill="none"
                viewBox="0 0 24 24"
                stroke-width="1.5"
                stroke="currentColor"
              ...
              <a
                href="info@mysite.com"
                className="group-hover:text-gray-400 cursor-pointer"
                target="_blank"
                rel="noopener noreferrer"
              >
                ticketresell@gmail.com
              </a>
            </div>
          </div>
